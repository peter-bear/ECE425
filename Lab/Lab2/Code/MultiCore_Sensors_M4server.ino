//MultiCore_Sensors_M7server.ino
...
void callSensorReadFromM7() {
  while (true) {
    ...
    RPC.println(currentCPU() + ": front: " + String(data.front) + ", back: " + String(data.back) + ", left: " + String(data.left) + ", right: " + String(data.right));
    RPC.println(currentCPU() + ": front left: " + String(data2.left) + ", front right: " + String(data2.right));
  }
}
